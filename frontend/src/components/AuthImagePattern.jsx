...
const CodeBackground = ({ title = "Welcome to our platform!", subtitle = "Sign up to access our platform and start using our services." }) => {
      ...
      <div className="z-10 max-w-md flex flex-col items-center">
        ...
        <div className="w-full bg-slate-800 rounded-lg shadow-xl mb-8 overflow-hidden">
          ...
          <div className="p-4 font-mono text-xs sm:text-sm overflow-hidden relative h-64">
            ...
            {/* Blinking cursor */}
            <div className="absolute bottom-4 right-4 w-2 h-4 bg-white animate-pulse"></div>
          </div>
        </div>
